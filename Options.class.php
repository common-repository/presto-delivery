...
class Prestomedia_Options {
	 ...
	 * @const string
	 */
	const OPTION_GROUP = 'prestomedia-auth';
	 ...
	 * @const string
	 */
	const OPTION_NAME = 'prestomedia-auth-secret';
	...
	/**
	 * Register prestomedia-post-secret option.
	 */
	...
	public function enqueue_scripts() {
		...
		$clipboard_url 	=$this->plugin_url . '/assets/clipboard.min.js';
		wp_enqueue_script( 'clipboard-js', $clipboard_url, array( 'jquery' ) );
	}
	...
	public static function set_initial_secret() {
		$secret = Prestomedia_HMAC_Auth::generate_secret();
